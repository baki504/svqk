...
public class PathParamOrderFilter implements OASFilter {
  ...
  public void filterOpenAPI(OpenAPI openAPI) {
    ...
    Map<String, Parameter> componentsParams =
  ...
  private static List<Parameter> reorder(
      List<Parameter> params, List<String> order, Map<String, Parameter> components) {
    return params.stream()
        .map(p -> new ResolvedParameter(p, components, order))
        .sorted(
            Comparator.comparing(ResolvedParameter::isPath)
                .reversed()
